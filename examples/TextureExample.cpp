...
void TextureExample::Initialize() {
	mRotation = 0.0f;
	mShader = new Shader("shaders/static.vs", "shaders/static.fs");
...
void TextureExample::Update(float inDeltaTime) {
	/*
...
void TextureExample::Render(float inAspectRatio) {
...
void TextureExample::OnLeftMouseButtonDown() {
	mRotation += 45.0f;
	while (mRotation > 360.0f) {
		mRotation -= 360.0f;
	}
...
void TextureExample::OnRightMouseButtonDown() {
	mRotation -= 45.0f;
	while (mRotation > 360.0f) {
		mRotation -= 360.0f;
	}
}
void TextureExample::OnWheelMouseButtonDown() {}

void TextureExample::OnLeftMouseButtonUp() {}
void TextureExample::OnRightMouseButtonUp() {}
void TextureExample::OnWheelMouseButtonUp() {}