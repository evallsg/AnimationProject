...
/*
Matrix-vector multiplication given a vector of three components. It creates automatically a four-component vector, assuming the vector represents the direction and magnitude.
*/
...
/*
Matrix-vector multiplication given a vector of three components. It creates automatically a four-component vector, assuming that the W component of the vector is 1.
*/
...
/*
It takes an additional W component.
...
//It flips every element of the matrix across its main diagonal.
...
/*
*View matrix is the inverse of the camera's transformation (the position, rotation, and scale of the camera).
